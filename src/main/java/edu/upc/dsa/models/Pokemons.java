...
public class Pokemons {
    ...
    public Pokemons(){};
    public Pokemons(String name, String type, Double level, LinkedList<Attack> attackList, Double maxHealth, Double actualHealth, Double probCapture, Double probAppear){
        this.name=name;
        this.type=type;
        this.level=level;
